...
import { Grid, List, Search, X, ArrowLeft } from "lucide-react";
import type {
  Product,
  ProductCategory,
  ProductForm,
...
import { BundleShell } from "@/components/catalog/bundle-shell";
        ...
        <div className="mb-6 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-ink-600">
              {showBundles ? `${bundles.length} paket rekomendasi` : `${sorted.length} produk`}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-full border text-sm font-semibold transition-all duration-200 cursor-pointer",
                showBundles
                  ? "bg-brand-900 text-white-soft border-brand-900"
                  : "border-line bg-white-soft text-brand-900 hover:border-brand-700"
              )}
            >
              Bundle
            </button>
        ...
        {showBundles ? (
          <div className="space-y-6">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-line bg-cream-50/50 hover:bg-cream-100 px-4 py-2 text-xs font-bold text-brand-900 transition-all cursor-pointer shadow-sm"
            >
